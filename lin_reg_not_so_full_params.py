""" This module uses Linear regression to predict student scores using the
 given parameters on students. In this part, the score(g3) will be calculated as a function
 of the parameters given in the dataset in addition to the scores(g1 and g2).
